class QuotesController < ApplicationController
  ...
  def create
    ...
    property.rent_rolls.create!(rent_roll_params) if property.rent_rolls.empty?
    ...
    created_quote = Quote.create!(loan_amount: loan_amount, debt_rate: quote_calculator.debt_rate)
